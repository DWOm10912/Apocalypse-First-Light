...
public final class NativeGunAmmoGameTests {
    ...
    public static void authoritativeFireAndRejectedReload(GameTestHelper h) {
        ...
        ItemStack gun = new ItemStack(AflItems.SERVICE_PISTOL.get());
        ...
        ServicePistolActions.request(player, true, 0);
        ServicePistolActions.request(player, false, 0);
        for (int i = 0; i < 20; i++) ServicePistolActions.request(player, false, 0);
        ...
        for (int shot = 2; shot <= 5; shot++) {
            ...
            h.runAfterDelay((shot - 1) * 4, () -> {
                ServicePistolActions.tick(new TickEvent.PlayerTickEvent(TickEvent.Phase.END, player));
                ServicePistolActions.request(player, false, 0);
    ...
    public static void stackPersistenceAndBounds(GameTestHelper h) {
        ...
        var item = AflItems.SERVICE_PISTOL.get();
