...
public final class AflItems {
    ...
    public static final RegistryObject<Item> SUPERMARKET_SHELF_SINGLE = ITEMS.register("supermarket_shelf_single",
            () -> new BlockItem(AflBlocks.SUPERMARKET_SHELF_SINGLE.get(), new Item.Properties()));
