...
public final class StartupPlainsEnclave {
    ...
    public static ResourceKey<Biome> resolveBiome(int x, int z, long seed, Holder<Biome> original) {
        ResourceKey<Biome> originalKey = original == null ? null : original.unwrapKey().orElse(null);
    ...
    private static ResourceKey<Biome> normalizeVanillaSurface(ResourceKey<Biome> originalKey) {
        if (originalKey != null && "minecraft".equals(originalKey.location().getNamespace())) {
