...
现行更新：[Highway V2 Route Graph Phase 1](highway_v2_route_graph_phase1.md) 已将 Highway 与其 claim 同步改为两条有限主干，在第一处宏观海岸前终止，不跨 OPEN_OCEAN；Sea Bridge 未实现。[Macro Geography V1](terrain_v2_macro_geography_v1.md) 的 Rural MAINLAND/海岸128格缓冲 gate（16格有界探针）保持。Rural planner、建筑、农业与冲突裁决算法未改。
