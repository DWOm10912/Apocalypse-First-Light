...
Inspect 当时将共享 `AflNetwork` 协议从22升为23，冷柜门扇后来升为24，撬棍砸玻璃升为25；厕所隔间门追加报文后升为 **26**；Field Attachment View V1 后当前为 **29**，两端须匹配。
...
旧 V 配件快速装拆不恢复；SightExchange 旧报文继续空操作，正式安装经维护台或 Z Field Attachment View，共用服务端交易。
