...
当前覆盖 P9-01、BR51-01、手枪微型红点、步枪红点、两种消音器与 P9-01 24发扩容弹匣。P9 静态容量规格随附件显示 17 或 24，不显示实时余量；实时弹药由 HUD 表示。扩容弹匣类型行“弹匣 ｜ 手枪 ｜ 24发”，描述“一款为P9-01设计的24发扩容弹匣，可提升持续交火能力。”，英文同步。附件正文不包含 V 键或安装教学。
