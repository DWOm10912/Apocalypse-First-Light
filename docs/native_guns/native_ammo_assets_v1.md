...
P9-01只吃9x19mm_round，BR51-01只吃762x51mm_round，12_7x55mm_round尚未绑定枪械；背包HUD统计沿用同一definition口径查询。已装枪内弹数NBT不重置。换弹时间、扣弹次数、dry-fire、伤害、精度、枪械模型、动画、Display均不变。
