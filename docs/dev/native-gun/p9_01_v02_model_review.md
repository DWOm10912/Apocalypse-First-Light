# AFL P9-01 Service Pistol V0.2 — model review
...
P9-01 Service Pistol sources and pre-material PNG below were removed from the editable
folder after a hash-verified archive was made at
`.gradle-user/asset-backups/p9-01-pre-v038-20260906.zip` (local, ignored).
Only `src/main/blockbench/p9_01_v03_8_fire_slide_cleanup.bbmodel` remains
...
- Source: `src/main/blockbench/p9_01_v02.bbmodel`.
- Preserved original: `src/main/blockbench/p9_01.bbmodel`.
- Exact backup: `src/main/blockbench/p9_01_v01_failed.bbmodel`.
- Project: `AFL P9-01 Service Pistol V0.2`.
- Format: `geckolib_model` / GeckoLib Animated Model, Model Type `Item`.
- Object ID: `p9_01`; Mod ID: `apocalypse_firstlight`.
...
- Texture name: `p9_01.png`. It is embedded in the bbmodel and requires no
...
Texture backup: `src/main/blockbench/p9_01_v02_texture_before_material_pass.png`.
...
embedded in `src/main/blockbench/p9_01_v02.bbmodel`.
...
Animated source: `src/main/blockbench/p9_01_v03_animated.bbmodel`.
The original `p9_01_v02.bbmodel` remains unchanged and static; the
earlier V0.2 status blocks above describe that version, not this successor.

- `animation.p9_01.fire`: once, 0.14 seconds. Slide travels +3.2 model
...
- `animation.p9_01.reload`: once, 1.2 seconds. Gun makes a restrained
...
`src/main/blockbench/p9_01_v03_3_ready_pose_fix.bbmodel`.
...
See `docs/dev/native-gun/p9_01_v03_rig_review.md` for the two-hand reload, magwell,
