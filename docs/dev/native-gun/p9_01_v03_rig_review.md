# P9-01 Service Pistol V0.3 rig and reference-arm review
...
1. `src/main/blockbench/p9_01_v03_animated.bbmodel`: input simple fire/reload.
2. `src/main/blockbench/p9_01_v03_two_hand_rig.bbmodel`: 83 cubes, 18 groups;
   hollow magwell, second magazine, two-hand debug reload. Preserved safety copy.
3. `src/main/blockbench/p9_01_v03_1_realistic_two_hand_pose.bbmodel`:
...
4. `src/main/blockbench/p9_01_v03_2_mc_arm_reference_rig.bbmodel`:
...
`animation.p9_01.reload` is once, **1.30 seconds**:
...
`animation.p9_01.fire` remains once, **0.14 seconds**. All original
...
`src/main/blockbench/p9_01_v03_4_left_support_pose.bbmodel`.
...
`src/main/blockbench/p9_01_v03_6_pose_clipping_cleanup.bbmodel`.
...
`src/main/blockbench/p9_01_v03_7_multi_fix_pass.bbmodel`.
...
Source: `src/main/blockbench/p9_01_v03_7_multi_fix_pass.bbmodel`.
Output: `src/main/blockbench/p9_01_v03_8_fire_slide_cleanup.bbmodel`.
